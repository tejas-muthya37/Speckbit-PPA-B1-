...
def browse():
	...
	if categories == "1":
		...
		print("\n", tabulate(apparel, headers, tablefmt="github"))
		...
		headers = ["Product", "Size", "Price in ₹"]
		print("\n", tabulate(shoe, headers, tablefmt="github"))
		add = input("\n\nWould you like to add anything to your cart?\n\t1. YES!\n\t2. NO!\n\t")
		if add == "1":
		...
		print("\n", tabulate(electronics, headers, tablefmt="github"))
		add = input("\n\nWould you like to add anything to your cart?\n\t1. YES!\n\t2. NO!\n\t")
		if add == "1":
			n = input("Enter the name of the product you want to add in your cart : ")
		...
		print("\n", tabulate(educational, headers, tablefmt="github"))
		add = input("\n\nWould you like to add anything to your cart?\n\t1. YES!\n\t2. NO!\n\t")
		if add == "1":
			n = input("Enter the name of the product you want to add in your cart : ")
